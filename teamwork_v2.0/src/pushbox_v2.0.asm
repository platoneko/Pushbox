...
display:
 ...
 jr $ra # unknown
type_0:
 addi $s0,$0,0x0 # ground
 j draw
type_1:
 addi $s0,$0,0x100 # wall
 j draw
type_2:
...
type_3:
 ...
 j draw
type_4:
 addi $s0,$0,0x400 # dest
 j draw
type_5:
 addi $s0,$0,0x500 # box_at_dest
draw:
...
go_up:
 ...
 add $t0,$t0,$s1
 sll $t0,$t0,2
 lw $s2,0x800($t0) # state at me.x, me.y
 addi $t1,$s0,-1
 sll $t0,$t1,4
 add $t0,$t0,$s1
 sll $t0,$t0,2
 lw $s3,0x800($t0) # state at me.x-1, me.y
...
go_up_type3:
 ...
 add $t0,$t0,$s1
 sll $t0,$t0,2
 lw $s4,0x800($t0) # state at me.x-2, me.y
...
go_left:
 ...
 add $t0,$t0,$t1
 sll $t0,$t0,2
 lw $s3,0x800($t0) # state at me.x, me.y-1
...
go_left_type3:
 ...
 add $t0,$t0,$t1
 sll $t0,$t0,2
 lw $s4,0x800($t0) # state at me.x, me.y-2
